        ...
        <ul className="pt-2 pb-4 space-y-6 text-sm">
          ...
          <li>
            <Link
              ...
              className={`flex items-center p-2 space-x-3 rounded-md ${isActive("/admin/dashboard/gallery") ? "bg-gray-300" : ""}`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
          ...
          <li>
            <Link
              ...
              className={`flex items-center p-2 space-x-3 rounded-md ${isActive("/admin/dashboard/video") ? "bg-gray-300" : ""}`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
