...
const Map = () => {
  return (
    <>
      <div
        className="w-full h-96 md:h-96 xl:h-auto rounded-lg shadow-sm overflow-hidden mt-10 xl:mt-0 lg:mt-0"
        data-aos="fade-up"
      ...
      >
        <iframe
          ...
          className="w-full xl:rounded-sm lg:rounded-sm shadow-md"
        />
      </div>
    </>
  );
